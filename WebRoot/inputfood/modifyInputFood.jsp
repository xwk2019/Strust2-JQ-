...
<div id="toptitle">
 ...
 <form action="saveInputFood.action?FoodNumber=<s:property value="FoodNumber"/>" method="post">
	...
	<tbody>
	  <s:iterator value="userlist">
		<tr id="main">  
		      <td>入库单号</td>
		      <td><input type="text" id="FoodEntryNum" name="inputFood.FoodEntryNum" value="<s:property value="FoodEntryNum"/>" readonly="readonly"/></td>
		      <td><span id="checkNumber"></span></td>
		      <td></td>
		</tr>
		<tr id="main">  
		      <td>商品编号</td>		     
		      <td><input type="text" id="FoodNumber" name="inputFood.FoodNumber" value="<s:property value="FoodNumber"/>"readonly="readonly"/></td>
