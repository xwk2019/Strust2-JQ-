...
<div id="toptitle">
 ...
 <form action="saveAllUser.action?userId=<s:property value="userId"/>" method="post" enctype="multipart/form-data" id="myform">
	...
	<tbody>
	 <s:iterator value="userlist">
		...
		<tr id="main">  
		      <td>账号</td>		     
		      <td><input type="text" id="userId" name="user.userId" value="<s:property value="userId"/>" readonly="readonly"/></td>
		...
		<tr id="main">  
		      <td>角色</td>		      
		      <td><input type="text" id="userPass" name="user.role" value="<s:property value="role"/>"/></td>
		      <td><span id="AcheckPrice"></span></td>
		      <td></td>
		</tr>
		</s:iterator>
